...
public class ConsumeMessageConcurrentlyService implements ConsumeMessageService {
    ...
    /**
     *按照consumeBatchSize的大小，分批次提交给线程池执行
     */
    @Override
    ...
    public void processConsumeResult(
        ...
        switch (this.defaultMQPushConsumer.getMessageModel()) {
            case BROADCASTING:
                for (int i = ackIndex + 1; i < consumeRequest.getMsgs().size(); i++) {//广播模式下，消费失败，直接丢弃
    ...
    class ConsumeRequest implements Runnable {
        ...
        public void run() {
            ...
            if (ConsumeMessageConcurrentlyService.this.defaultMQPushConsumerImpl.hasHook()) {//执行前置钩子函数
            ...
            if (ConsumeMessageConcurrentlyService.this.defaultMQPushConsumerImpl.hasHook()) {//执行后置钩子函数
